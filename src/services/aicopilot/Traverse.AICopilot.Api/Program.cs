// ============================================================================
// Traverse.AICopilot.Api — Program.cs
...
//
// NOTE: Traverse.AI.Abstractions and Traverse.AI.Providers are NOT referenced
// in Phase 0 (YAGNI — not used until Phase 1 AICopilot story). The AI SDK
// transitive dependencies (OpenAI, Anthropic, AWS Bedrock) are avoided in
// this stub to keep the project minimal.
//
...
// ---------------------------------------------------------------------------
builder.AddTraverseObservability("aicopilot-service");
